    ...
    <html lang="en">
      <body>
        <div id="wrapperDiv" className={inter.className + " " + styles} style={{backgroundImage: "url('/assets/image/background-global.PNG')", backgroundSize: "cover", backgroundRepeat: "no-repeat"}}>
          ...
          <div id="WorkDiv" className="relative basis-full flex flex-col justify-between px-8 pt-8 bg-white bg-opacity-90 rounded-md shadow-lg overflow-y-scroll overflow-x-hidden">
            {children}
          </div>
        </div>
      </body>
