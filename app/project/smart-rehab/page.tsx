   ...
   <div id="smart-rehab" className="pt-4 pb-16 overflow-x-hidden" style={{ backgroundImage: `url("/assets/image/background-global-repeat-2.PNG")` }}>
    ...
    <div className="flex flex-col gap-[10vh] md:gap-[10vh]">
      <div id="intro" className="relative">
          <div className="absolute top-[8vh] left-0 right-0 w-1/3 md:w-1/2 sm:w-1/2 lg:w-1/2 h-[800px] bg-gradient-to-bl from-[#EACC5C] to-[#DF9141] rounded-md mx-auto -translate-x-[20%]" />
      ...
      <div id="block2" className="flex justify-between gap-8 px-8 sm:px-2">
        ...
        <div className="relative w-2/3 right-0 aspect-[16/9] sm:scale-[2]">
          <Image
