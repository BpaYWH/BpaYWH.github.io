...
const Wave = ({ className = "", style = {} }: { className?:string, style?: React.CSSProperties }) => (
   <svg viewBox="0 0 400 170" className={className} style={style}>
      <path d="M 200 15 C 240 0 260 0 300 15 C 340 30 360 30 400 15 L 400 185 L 0 185 L 0 15 M 0 15 C 40 0 60 0 100 15 C 140 30 160 30 200 15" stroke="gray" fill="cyan" />
   </svg>
)   
